...
namespace QuanLyDaiHocGiaDinh.Views
{
    ...
    public partial class OutlookAppointmentForm : DevExpress.XtraBars.Ribbon.RibbonForm, IDXManagerPopupMenu
    {
        ...
        {
            if (appointment.CustomFields["AccountId"] != null)
                _AccountId = appointment.CustomFields["AccountId"].ToString();
            laAccountId.Text = "ID: " + _AccountId;
            //do nothing
        }
        public virtual bool SaveFormData(Appointment appointment)
        {
            appointment.CustomFields["AccountId"] = laAccountId.Text;
            return true;
        }
        public virtual bool IsAppointmentChanged(Appointment appointment)
        {
            if (_AccountId == appointment.CustomFields["AccountId"].ToString())
                return false;
            else
                return true;
        }
